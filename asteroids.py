# modelo de programa para nave espacial orientado a eventos em py
import simplegui
import math
import random

# globals para interface do usuário
WIDTH = 800
HEIGHT = 600
score = 0
lives = 3
...
S_MESSAGE = "PARADIGMA ORIENTADO A EVENTOS"

class RGBcolor:
    
   # cria cor com intensidades especificadas
...
# recursos de arte criados por Kim Lathrop, podem ser reutilizados livremente em projetos não comerciais, por favor credite Kim
    
# imagens de detritos - debris1_brown.png, debris2_brown.png, debris3_brown.png, debris4_brown.png
...
#funções auxiliares para lidar com transformações
